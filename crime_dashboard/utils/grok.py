...
def interact_with_data(crimesData, moneyImages, userInput):
    ...
    XAI_API_KEY = "xai-VKwx6Fz6V7glvQcwHWzEEYZiv5vNBGiMTpCzZIsZ1UOsOTOeh4BbSD3BxrGIvzC9axPR9fdfUHwKi5x2"
    XAI_API_KEY2= "xai-8oqn6UXkn3RVRKnWpj4bk20IoO1R9PiZff1xhRWkzkCt19Ft9p4NAjlRE7yDm9SYWHPM917oeg3aEGkP"

    client = OpenAI(
        api_key=XAI_API_KEY2,
